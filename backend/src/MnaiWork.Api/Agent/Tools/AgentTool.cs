...
public sealed record ToolResult(bool Success, string Output, Artifact? Artifact = null)
{
    public static ToolResult Ok(string output, Artifact? artifact = null) => new(true, output, artifact);
